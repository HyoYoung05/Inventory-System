...
<head>
    ...
    <title><?= isset($pageTitle) ? $pageTitle . ' - ' : '' ?>Admin Dashboard | Inventory System</title>
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="<?= site_url('admin/categories') ?>" class="<?= strpos(current_url(), 'admin/categories') !== false ? 'active' : '' ?>">
                        <i class="bi bi-tag"></i>
                        <span>Categories</span>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('admin/orders') ?>" class="<?= strpos(current_url(), 'admin/orders') !== false ? 'active' : '' ?>">
            ...
            <div class="sidebar-user">
                <div class="user-info">
                    <div class="user-avatar">
                        <?= strtoupper(substr(esc($username ?? 'Admin'), 0, 1)) ?>
                    </div>
                    <div class="user-details">
                        <div class="user-name"><?= esc($username ?? 'Admin') ?></div>
                        <div class="user-role"><?= esc($role ?? 'Administrator') ?></div>
                    </div>
                </div>
        ...
        <div class="main-content">
            <!-- Topbar -->
            <div class="topbar">
                <h1 class="topbar-title"><?= $pageTitle ?? 'Admin Dashboard' ?></h1>
