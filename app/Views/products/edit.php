...
<div class="container mt-4">
    ...
    <div class="form-card">
        <h1 class="form-title"><i class="bi bi-pencil-square"></i> Edit Product</h1>
        ...
        <form action="<?= base_url('products/update/' . $product['id']) ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="price" name="price" value="<?= old('price', $product['price']) ?>" placeholder="0.00" required>
            </div>
            <div class="form-group">
                <label for="stock"><i class="bi bi-stack"></i> Stock Quantity</label>
                <input type="number" class="form-control" id="stock" name="stock" value="<?= old('stock', $product['stock']) ?>" placeholder="0" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit"><i class="bi bi-check-lg"></i> Update Product</button>
