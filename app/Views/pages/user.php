...
<body>
    ...
    <div class="container py-5">
        <div class="card shadow-sm">
            <div class="card-body">
                <h1 class="card-title"><i class="bi bi-person"></i> User Dashboard</h1>
                <p class="card-text">You can view inventory information and reports.</p>
                <hr>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <a href="<?= base_url('products') ?>" class="btn btn-primary btn-lg w-100">
                            <i class="bi bi-box-seam"></i> View Products (Read-Only)
                        </a>
                    </div>
                </div>
            </div>
